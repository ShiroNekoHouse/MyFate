...
class HeteroFTLTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        ...
        self.host_loss_share=Variable(name="HeteroFTLTransferVariable.host_loss_share",auth={'src':"host",'dst':['guest']})
        self.host_gradient_share_to_guest=Variable(name="HeteroFTLTransferVariable.host_gradient_share_to_guest",auth={'src':"host",'dst':['guest']})
        self.guest_gradient_share_to_host=Variable(name="HeteroFTLTransferVariable.guest_gradient_share_to_host",auth={'src':"guest",'dst':['host']})
